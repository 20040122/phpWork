...
<div class="main">
    ...
    <script>
        ...
        function redirectToBuy() {
            ...
            // 获取商品价格
            const productPrice = button.parentElement.dataset.productPrice;

            const url = `buy.php?productId=${productId}&productPrice=${productPrice}`;
    ...
    <!--    商品列表模块-->
    <div class="container">
        <div class="product"data-product-id="1" data-product-price="600">
        ...
        <div class="product"data-product-id="2" data-product-price="1000" >
        ...
        <div class="product"data-product-id="3" data-product-price="700">
        ...
        <div class="product"data-product-id="4" data-product-price="500">
        ...
        <div class="product"data-product-id="5" data-product-price="600">
        ...
        <div class="product"data-product-id="6" data-product-price="400">
        ...
        <div class="product"data-product-id="7" data-product-price=400">
        ...
        <div class="product"data-product-id="8" data-product-price="400">
